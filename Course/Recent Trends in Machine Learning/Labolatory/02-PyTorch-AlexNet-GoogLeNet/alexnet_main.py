...
#Train!
best_model, val_acc_history, loss_acc_history = train_model(alexnet_module, dataloaders, criterion, optimizer, device, 10, 'alex_module_lr_0.001_bestsofar')

#Save training statistics 
with open('alex_module_lr_0.001_bestsofar.pkl','wb') as f:
