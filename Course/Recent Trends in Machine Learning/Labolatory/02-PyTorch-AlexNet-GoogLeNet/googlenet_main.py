...
#Train!
best_model, val_acc_history, loss_acc_history = train_model(googlenet, dataloaders, criterion, optimizer, device, 10, 'googlenet_module_lr_0.001_bestsofar')

#Save training statistics 
with open('googlenet_module_lr_0.001_bestsofar.pkl','wb') as f:
